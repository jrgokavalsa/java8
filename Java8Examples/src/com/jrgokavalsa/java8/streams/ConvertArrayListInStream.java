package com.jrgokavalsa.java8.streams;
...
public class ConvertArrayListInStream {
	...
	public static void main(String[] args) {
		...
		// display all record in sorted manner (ascending) that starts with 'a' in
		// stringList
		...
		// display all record in sorted manner (descending) that starts with 'a' in
		// stringList
		...
		stringList.stream().filter(s -> s.startsWith("a")).map(String::toUpperCase).sorted()
				.forEach(System.out::println);
